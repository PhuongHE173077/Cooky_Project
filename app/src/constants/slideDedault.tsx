export const dataSlider = [
  ...
  { _id: 6, image_url: 'https://soliloquywp.com/wp-content/uploads/2013/05/action-backlit-beach-1046896.jpg', title: 'Black Friday', subText: ' Sale to 50 % and have many vochers' },
