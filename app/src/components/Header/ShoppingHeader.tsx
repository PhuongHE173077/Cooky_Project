    ...
    <View>
      ...
      <View style={{
        ...
        >
          ...
          <Text style={{ position: 'absolute', top: -5, right: -12, backgroundColor: Colors.PRIMARY, padding: 4, paddingHorizontal: 7, borderRadius: 99, fontSize: 12, color: Colors.WHITE }}>2</Text>
        </TouchableOpacity>
